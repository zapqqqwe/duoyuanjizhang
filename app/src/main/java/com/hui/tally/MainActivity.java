...
import com.hui.tally.community.Main_comActivity;
import com.hui.tally.community.community;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void initView() {
        ...
        comBtin=findViewById(R.id.mycommunity);
        editBtn.setOnClickListener(this);
        moreBtn.setOnClickListener(this);
        searchIv.setOnClickListener(this);
        comBtin.setOnClickListener(this);
...
//    设置显示运算剩余
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            { Intent its = new Intent(this, Main_comActivity.class);  //跳转界面
                startActivity(its);
               // PackageManager pac=MainActivity.this.getPackageManager();
                //Intent intent=pac.getLaunchIntentForPackage("com.knewbie.news");
